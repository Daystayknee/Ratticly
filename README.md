...
- Quick-add forms for animals, offspring groups, measurements, health, reproductive events, feeding logs, behavior logs, facilities, tasks, expenses, and journals
- Species profile engine with terminology, widgets, and alert logic for rats, snakes, and horses
- Expanded animal tracking tabs: identity, physical, reproduction, genetics, health, husbandry, feeding/output, behavior, offspring, sales/performance, and files/timeline
- Backup controls:
